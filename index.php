			    ...
			    <tbody>
			    	<?php
						...
						<tr>
				            ...
				            <td><a href="https://www.google.ru/maps/place/'.$row['local'].'" target="_blank">'.$row['local'].'</a></td>
				            <td>'.$row['note'].'</td>
				            <td>
				            	<a href="edit.php?user='.$row['id'].'" onclick="window.open(this.href, \'mywin\', \'left=20,top=20,width=500,height=665,toolbar=0,resizable=0\'); return false;" title="Редактировать"><i class="glyphicon glyphicon-edit"></i></a>
